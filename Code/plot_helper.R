...
# function: plot_mc
# Description:        This function plots Mclust result.
# Input:
#         x           =   Mclust fitting result.    
#
plot_mc <- function(x) {
...
# function: plot_rem
# Description:        This function plots EM_robust result
# Input:
#         sim_EMfit     =       EM_robust fitting results.
